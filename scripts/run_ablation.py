...
def parse_args():
    ...
    ap.add_argument("--ds_metric", default="./data/MSDS-save-metric", help="cache for MetricOnly")
    ap.add_argument("--ds_fusion", default="./data/MSDS-save-fusion", help="cache for MetricTraceFusion*")
